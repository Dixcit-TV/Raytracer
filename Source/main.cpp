...
void InitScene2()
{
	...
	scene2.AddObject(new Plane(Elite::FMatrix4{ Elite::MakeRotationX(float(E_PI_DIV_2)), Elite::FPoint3(0.f, 0.f, -10.f) }, MaterialManager::GetInstance()->GetMaterial("Mat_LambertCookTorrance_Yellow")));
	scene2.AddObject(new Plane(Elite::FMatrix4{ Elite::MakeRotationZ(float(E_PI_DIV_2)), Elite::FPoint3(10.f, 0.f, 0.f) }, MaterialManager::GetInstance()->GetMaterial("Mat_LambertCookTorrance_Yellow")));
	scene2.AddObject(new Plane(Elite::FMatrix4{ Elite::MakeRotationZ(float(-E_PI_DIV_2)), Elite::FPoint3(-10.f, 0.f, 0.f) }, MaterialManager::GetInstance()->GetMaterial("Mat_LambertCookTorrance_Yellow")));
